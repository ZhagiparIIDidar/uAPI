...
public class DatabaseInitializer {
    ...
    public static void insertTestData() {
        try (Connection conn = DatabaseManager.getConnection();
            ...
            // requests
            stmt.execute("""
                    INSERT OR IGNORE INTO requests (request_id, sender_login, content, status, request_type) VALUES
                    (1, 'student1', 'OOP Monday 10:00-12:00', 'PENDING', 'SCHEDULE'),
                    (2, 'student1', 'Register for Algorithms', 'PENDING', 'REGISTRATION');
                    """);
